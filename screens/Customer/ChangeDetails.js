...
const ChangeDetails = ({navigation}) => {
    ...
    const handleEmail = async (credentials, setSubmitting) => {
        setSubmit(true);
        handleMessage(null);
        const url = `${baseAPIUrl}/users/updateEmail`;
    ...
    const handleName = async (credentials, setSubmitting) => {
        setSubmit(true);
        handleMessage(null);
        const url = `${baseAPIUrl}/users/updateName`;
        axios.post(url, credentials)
            .then((response) => {
                const result = response.data;
                const {message, status, data} = result; 
    ...
    const handlePhone = async (credentials, setSubmitting) => {
        ...
        const url = `${baseAPIUrl}/users/updatePhone`;
        axios.post(url, credentials)
            .then((response) => {
                const result = response.data;
                const {message, status, data} = result; 
    ...
    const handlePassword = async (credentials, setSubmitting) => {
        setSubmit(true);
        handleMessage(null);
        const url = `${baseAPIUrl}/users/updatePassword`;
        axios.post(url, credentials)
            .then((response) => {
                const result = response.data;
                const {message, status, data} = result; 
    ...
    const uploadImage = async () => {    
        // console.log(credentials);   
        const url = `${baseAPIUrl}/users/updatePhoto`;
